...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-base leading-snug font-semibold text-[var(--color-text-heading)] group-data-[size=sm]/card:text-sm",
        className,
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-[var(--radius)] border-t border-border bg-primary-tint/40 p-(--card-spacing)",
        className,
      )}
      {...props}
    />
