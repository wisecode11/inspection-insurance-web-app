...
export function HeroVisual({ className }: { className?: string }) {
  return (
    <div className={cn("relative w-full max-w-[36rem] md:max-w-none", className)}>
      <div
        aria-hidden
      ...
      />
      <Image
        src="/images/hero-phone-inspector-hd.png"
        alt="RoofClaim Inspector Portal — field jobs, progress stats, and claim-ready inspections"
        width={2048}
        height={2048}
        priority
        quality={100}
        className="relative z-10 -mt-6 h-auto w-full select-none drop-shadow-[0_28px_50px_rgba(27,67,50,0.18)] sm:-mt-8 md:-mt-10 lg:-mt-12"
